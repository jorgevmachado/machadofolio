...
describe('Pokemon Move Service' ,() => {
  ...
  const effectEntryMock: MoveResponse['effect_entries'][number] = {
    effect: 'effect' ,
    language: { name: 'en' ,url: 'https://pokemon-mock/language/9/' } ,
  ...
  describe('getOne' ,() => {
    ...
    it('Should return a move of Pokemon with effect and short_effect empty' ,
      async () => {

        mockPokeApi.move.getByOrder.mockResolvedValue(
          { ...moveResponseMock ,effect_entries: [] });
    ...
    it(
      'Should return a move of Pokemon with effect and short_effect in other language when dont find language en' ,
      async () => {
        mockPokeApi.move.getByOrder.mockResolvedValue(
          { ...moveResponseMock ,effect_entries: [{
              ...effectEntryMock,
              language: { name: 'pt' ,url: 'https://pokemon-mock/language/9/' } ,
            }] });
