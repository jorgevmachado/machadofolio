...
### **Contact**
#### Utilitários relacionados a manipulação ou validação de formas de contato (telefone, e-mail e etc).
...
### **Date**
#### Utilitários relacionados a manipulação ou validação de datas com Subutilitários para manipulação de mes.
...
### **Error**
#### Classe de utilitário relacionado a tratamento de erros.
####
```bash
...
### **File**
#### Utilitários relacionados a manipulação ou validação de arquivos.
...
### **Http**
#### Classe de utilitário para manipular chamadas HTTP gerenciar requisições e respostas.
...
### **Number**
#### Utilitários relacionados a manipulação ou validação de 'number'.
...
### **Password**
#### Utilitários relacionados a manipulação ou validação password.
...
### **Personal Data**
#### Utilitários relacionados a manipulação ou validação de dados pessoais (cpf, nome e etc).
...
### **UUID**
#### Utilitário que fornece funções relacionadas ao uso de UUIDs.
