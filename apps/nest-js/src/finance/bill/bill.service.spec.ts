...
import { type CycleOfMonths, MONTHS } from '@repo/services';

import { BillBusiness, EBillType } from '@repo/business';
...
describe('BillService', () => {
    ...
    describe('create', () => {
        ...
        it('should create a bill successfully with type credit card', async () => {
            ...
            jest.spyOn(service, 'customSave' as any).mockResolvedValueOnce({
                ...mockEntity,
                type: EBillType.CREDIT_CARD
            });

            expect(await service.create(financeMockEntity, createBill)).toEqual({
                ...mockEntity,
                type: EBillType.CREDIT_CARD
            });
        });
