...
describe('PokemonGrowthRateService', () => {
    ...
    let repository: Repository<PokemonGrowthRate>;
    ...
    beforeEach(async () => {
        ...
        const module: TestingModule = await Test.createTestingModule({
            providers: [
                ...
                { provide: getRepositoryToken(PokemonGrowthRate), useClass: Repository },
            ],
        }).compile();

        service = module.get<PokemonGrowthRateService>(PokemonGrowthRateService);
        repository = module.get<Repository<PokemonGrowthRate>>(getRepositoryToken(PokemonGrowthRate));
    });
